...
export default function CustomDrawerContent(props: DrawerContentComponentProps) {
  ...
  return (
    <DrawerContentScrollView {...props}>
      {/* 用户信息区域 */}
      <Card style={[styles.userSection, { backgroundColor: theme.colors.primary }]}>
        <TouchableOpacity 
          style={styles.userInfo}
          onPress={() => navigateAndCloseDrawer("/mine")}
        >
          <Avatar.Image
            source={{ uri: 'https://raw.githubusercontent.com/wilhelmaoi/assets/ae663e7a1ef975e17915e2ab7536d6a7269a01fe/sunote/avatar.jpg' }}
              // style={styles.avatar}
            style={styles.avatar}
          />
...
>
  <View style={{  borderRadius: 15,    marginTop: 20,
      height: 60,flexDirection: 'row', alignItems: 'center',backgroundColor: '#e85C8A', }}>
  ...
  >
      ...
      <Text style={{ color: '#fff', fontSize: 30, fontFamily: 'mini-jian-huangcao', }}>大</Text>
    </View>
    </View>
    <View>
      <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 14 }}>我的大会员</Text>
      <Text style={{ color: '#fff', fontSize: 13, opacity: 0.85, marginTop: 2 }}>你所热爱的就是你的生活</Text>
    </View>
    <View>
      <Text style={{ color: '#fff', fontSize: 13, marginLeft: 25 , fontWeight: 'bold'}}>赞助作者 &gt;</Text>   
      </View>
      </View>
      </TouchableOpacity>
